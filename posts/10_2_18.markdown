...
Below are the two main functions in the Life Component. The component stores various options and the current life. When the player holds left or right click, they will call these functions on their target (if that target has this component).
